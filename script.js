...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const events = [
    ...
    ["20260919", "Talent Show - Season 1 & Dhol Tasha Vaadan", "Talent Show - Season 1. Dhol Tasha Vaadan: 4:00 PM–6:00 PM IST, ground floor near the Pandal. Sponsored by the Cricket team. Thank you to the Cricket team for their support!"],
    ["20260920", "Community Activity Day", "Drawing Competition for Kids: 11:00 AM–12:30 PM IST (rescheduled due to children’s school commitments). Blood Donation (coordinators: Deepak Karade & Sameer Gandhi); Treasure Hunt; Thali & Rangoli Competition (bring your completed pooja thali to the Pandal at 6:00 PM); Fun n Fair (coordinator: Priyank Sharma)."],
